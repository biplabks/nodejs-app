...
exports.updateStore = async (req, res) => {
    // set the location body to be a point
...
exports.getStoreBySlug = async (req, res, next) => {
    ...
    //if left side has same name to right side, then the parameter can be passed as name only[store: store or store]
    ...
    const q = {
        location: {
            $near: {
                ...
                $maxDistance: 10000 //10km, 10000 meters
            }
        }
    };
